// const ApiRootUrl = 'https://xiaolijiyin.com/mall/';
const ApiRootUrl = 'http://8239a763.ngrok.io/';
...
module.exports = {
  ...
  GoodsJustBuy: ApiRootUrl + 'goods/justBuy',  //商品详情页的关联商品（大家都在看）
  ...
  OrderSubmitJustBuy: ApiRootUrl + 'order/submitJustBuy', // 提交订单（直接购买）
  ...
  FeedbackAdd: ApiRootUrl + 'feedback/add',  //删除足迹
};